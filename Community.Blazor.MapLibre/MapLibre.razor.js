...
export function addDrawTool(container, position) {
    const map = mapInstances[container];
    ...
    const styles = [{
        ...
        'paint': {'fill-color': '#E53935', 'fill-outline-color': '#E53935', 'fill-opacity': 0.3}
    }, {
        'id': 'gl-draw-polygon-fill-active',
        'type': 'fill',
        'filter': ['all', ['==', 'active', 'true'], ['==', '$type', 'Polygon']],
        'paint': {'fill-color': '#E53935', 'fill-outline-color': '#E53935', 'fill-opacity': 0.1}
    }, {
        'id': 'gl-draw-polygon-midpoint',
        'type': 'circle',
        'filter': ['all', ['==', '$type', 'Point'], ['==', 'meta', 'midpoint']],
        'paint': {'circle-radius': 3, 'circle-color': '#E53935'}
    }, {
        ...
        'filter': ['all', ['==', 'active', 'true'], ['==', '$type', 'Polygon']],
        'layout': {'line-cap': 'round', 'line-join': 'round'},
        'paint': {'line-color': '#E53935', 'line-dasharray': [0.2, 2], 'line-width': 2}
    }, {
...
export function addTerraDrawTool(container, position) {
    ...
    const draw = new MaplibreTerradrawControl.MaplibreTerradrawControl({
        modes: ['render','point','linestring','polygon','rectangle','circle','freehand','freehand-linestring','select','delete-selection','delete'],
        open: true,
    });
    map.addControl(draw, position);
}
